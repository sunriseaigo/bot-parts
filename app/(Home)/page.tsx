...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div
        style={{ marginTop: "-2px" }}
        className="px-16 flex bg-primary text-white justify-center xl:text-[22px] lg:text-[16px] md:text-[14px] text-[12px] flex-wrap"
      >
      ...
      <Container>
        ...
        <div className="flex flex-col-reverse lg:flex-row mt-12 gap-12">
          ...
          {/* RIGHT */}
          <div className="">
            <div className="text-center lg:text-left font-medium text-[48px] max-2xl:text-[36px] max-md:text-[30px] text-primary">
              Доставимо запчастини з Європи
            </div>
            ...
            <div className="flex max-sm:flex-col max-sm:items-center mt-4 gap-4 justify-between">
              {section1Items.map((item, index) => (
                <div
                  key={index}
                  className="max-w-[390px] text-primary flex flex-col items-center border- border-blac"
                >
                  <Image
                    src={item.img}
                    alt=""
                  ...
                  />
                  <div className="flex justify-center md:text-[32px] text-[22px] my-3">
                    {item.title}
                  </div>
                  <div className="flex text-center md:text-[18px] text-[14px]">
                    {item.des}
                  </div>
                </div>
              ))}
      ...
      <div className="mt-24">
        <div
          className="bg-cover bg-center  h-[562px]"
          style={{
          ...
          <Container className="h-[562px]">
            <div className="max-w-[755px] h-full flex flex-col justify-center">
              ...
              <div className="pt-8 flex gap-6 max-md:flex-col justify-between font-bold text-[21px]">
                <button
                  className="bg-secondary w-[360px] h-[64px] max-md:w-[280px]"
                  style={{ borderRadius: "37px" }}
                >
                  Залишити заявку
                </button>
                <button
                  className="text-secondary w-[360px] h-[64px] max-md:w-[280px] border-2 border-secondary"
                  style={{ borderRadius: "37px" }}
                >
      ...
      {/* SECTION-05 */}
      <div className="mt-36">
        <div className="font-semibold text-[36px] text-center text-primary">
          Співпрацюємо в Європі та Україні
        </div>
        ...
        <Container>
          ...
          <div className="flex max-lg:flex-col gap-8 mt-16 ">
            {section3Items.map((item, index) => (
              <div
                key={index}
                className="card-shadow text-primary p-8 w-1/3 max-lg:w-full border-2 border-primary"
                style={{ borderRadius: "37px" }}
              >
                ...
                <div className="pb-4 text-gray-400 pt-2">
                  Останнє замовлення: 23.08.2023
                </div>
                <p className="text-[20px]">{item.des}</p>
              </div>
            ))}
      ...
      <div className="mt-36 py-12 text-primary bg-secondary">
        <Container className="flex w-1/2  max-lg:w-full">
          <div className="font-semibold text-[48px] max-xl:text-[38px] max-lg:text-[34px] max-md:text-[28px] max-sm:text-[24px]">
            Ми любимо свою роботу і активно ділимося своїм досвідом у
            соцмережах:
          </div>
        </Container>
      </div>
      <Container className="flex max-lg:flex-col gap-12 w-full">
        <div className="w-1/2 max-lg:w-full">
          ...
          <div className="pt-12">
            Commodo volutpat aliquet a placerat cras. Id morbi lacus ac faucibus
            in orci et nunc. Malesuada senectus dignissim adipiscing tincidunt
            ut. Dignissim facilisi magna facilisis at pulvinar vulputate
            tristique. Sed ultricies commodo mi maecenas velit accumsan sed.
            Fringilla viverra quis sociis justo turpis turpis sit. Sit
            sollicitudin netus in erat bibendum diam vitae ullamcorper.{" "}
          </div>
        </div>
      ...
      <div className="mt-40 py-8 text-primary bg-secondary font-bold text-[32px] text-center">
        <Container className="flex justify-center gap-8 flex-wrap">
          ...
          <button className="bg-primary text-white text-[22px] py-2 px-8 rounded-[36px]">
            Залишити заявку фіол
          </button>
        </Container>
      </div>
    </div>
