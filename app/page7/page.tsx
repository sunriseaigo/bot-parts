...
const Page7 = () => {
  return (
    <div className='pt-20 pb-40 text-primary'>
      ...
      {/* SECTION-02 */}
      <div className='mt-36 py-4 bg-secondary text-center text-[36px] max-lg:text-[24px] max-md:text-[18px] font-bold'>
        <Container>Правила повернення автозапчастин</Container>
      </div>
      <Container className='flex w-full max-md:flex-col gap-8 pt-12'>
        {/* LEFT */}
        <div className='w-1/2 max-md:w-full'>
      ...
      {/* SECTION-03 */}
      <div className='mt-36 py-4 bg-secondary text-center text-[36px] max-lg:text-[24px] max-md:text-[18px] font-bold'>
        <Container>Правила повернення автомобільних аксесуарів та сезонних товарів</Container>
      </div>
      <Container className='flex w-full max-md:flex-col gap-8 pt-12'>
        {/* LEFT */}
        <div className='w-1/2 max-md:w-full'>
